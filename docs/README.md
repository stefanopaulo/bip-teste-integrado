...
_Nota sobre portas: Por padrão, a API está exposta na porta 8085 para evitar conflitos com outros serviços locais (como o Tomcat padrão na 8080). Caso precise alterar, edite o arquivo .env na raiz._
